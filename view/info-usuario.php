...
<body>
    ...
    <div class="overflow-hidden  " style="background-color: aqua;">
        <!--text-center-->
            ...
            <div class="p-2 border bg-light">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text" id="espessur">Senha cadastrada: <?php echo $prop['senha']; ?></p>
                        <p class="card-text" id="valor">CPF: <?php echo $prop['cpf']; ?></p>
                        <p class="card-text" id="peso">Data Nascimento: <?php echo $prop['dataNascimento']; ?></p>
                        <p class="card-text" id="tam">Telefone: <?php echo $prop['telefone']; ?></p>
                        <p class="card-text" id="largur">Endereço: <?php echo $prop['endereco']; ?></p>


                        <a href="cadastrar-usuario.php?id=<?php echo $prop['id']; ?>" class="meubotao_selecione btn" style="background-color: green; color: white;">Atualizar Infomações</a>

                        <button type="button" class="meubotao_selecione btn" style="background-color: red; color: white;" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Excluir cliente</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="background-color: rgba(229, 208, 133, 1);">
                <div class="modal-header">
                    <h4 class="modal-title" id="staticBackdropLabel" style="color: red;">
                ...
                <div class="modal-footer">
                    <form name="excluir-usuario" method="post" action="../database/db-usuario-remover.php?id=<?php echo $prop['id']; ?>">
