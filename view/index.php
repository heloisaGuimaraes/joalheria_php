      ...
      <div class="menu_inferior d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <div class="dropdown">
          ...
          <ul class="menu_susp dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li><a class="meu_linkado dropdown-item" href="cadastrar-produto.php">Cadastrar</a></li>
        ...
        <div class="p-2 border bg-light">
          ...
          <div class="card img-fluid">
            ...
            <div class="card-body">
              ...
              <p class="card-text"></p>
              <a href="telaItem.html" class="btn btn-primary mb-2">Comprar</a>
              <a href="telacarrinho.html" class="btn btn-primary">Adcionar ao carrinho</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="p-2 border bg-light">
          ...
          <div class="card img-fluid">
            <img src="IMAGENS/icon.png" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Pulseira</h5>
              <p class="card-text"></p>
              <a href="telaItem.html" class="btn btn-primary mb-2">Comprar</a>
              <a href="telacarrinho.html" class="btn btn-primary">Adcionar ao carrinho</a>
            </div>
